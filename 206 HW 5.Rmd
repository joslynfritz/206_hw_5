...
test <- ggplot(data = female_prop, aes(x = 1995, 2000, 2015, fill = "Education", "Engineering", "Humanities & Art", "Physical Earth Sciences" )) +   
...
med_salary_male <- ggplot(data = med_salary, aes(x = field, y = male, fill = status)) +   geom_bar(stat = "identity", position = "dodge")
